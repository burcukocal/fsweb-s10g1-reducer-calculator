...
import { addOne, applyNumber, changeOperation, clearDisplay, MEMORY_PLUS, MEMORY_RECALL, MEMORY_CLEAR } from './actions';
        ...
        <div className="col-md-12 d-flex justify-content-center">
          <form name="Cal">
            ...
            <div className="row">
              ...
              <CalcButton value={"MR"} onClick={() => dispatch({type: MEMORY_RECALL})} />
